...
<head>
  ...
  <link rel="stylesheet" href="assets/public/css/vegas.min.css">
	...
	<link rel="stylesheet" href="assets/public/css/jquery.countdown.css">
		...
		<div class="row">
			<div class="col-md-offset-2 col-md-8 col-sm-12">
				<div class="section-title">
					...
					<p class="wow fadeInUp" data-wow-delay="0.6s">Yang kau mau, akan kami turuti. Tapi maaf kami tidak bisa menuruti semua yang kau mau.</p>
				</div>
            ...
            <div class="col-md-6 col-sm-6">
            	<input name="emailMessages" type="email" class="form-control" placeholder="example@email.com" required>
   			  	...
   			  	<div class="col-md-12 col-sm-12">
	   					<textarea name="messageMessages" class="form-control" placeholder="Apa yang kamu mau?" rows="6" required></textarea>
      	  	</div>
      ...
      <div class="col-md-4 col-sm-6">
        <h2>java jazz</h2>
          <div class="wow fadeInUp" data-wow-delay="0.3s">
             <p class="text-justify">Sebuah konser besar besaran, tapi tidak melebih lebihkan. Dapat ditonton oleh orang yang tuli, dan dapat didengar oleh orang buta. Berlaku untuk semua kalangan, baik muda maupun yang tidak dapat diperkerikan seperti apa mudanya.<br> Jangan lupa untuk senang.</p>
             <p class="copyright-text">Copyright &copy; 2018 Tukang Koding<br>
             Modified Design by <a rel="nofollow" href="" target="_parent">Tukang Koding</a></p>
          </div>
      </div>
          ...
          <input name="nama_pembeli" type="text" class="form-control" id="nama_pembeli" placeholder="Full Name">
					...
					<?php
						if (isset($_SESSION['id_customer'])) {
							...
							$sql = "SELECT email FROM customers WHERE id_customer = $id_customer";
							$brandResult = $connect->query($sql);
							while($row = $brandResult->fetch_array()){
								echo "<input name='email_pembeli' type='text' value='".$row[0]."' class='form-control' id='email' placeholder='Email Address'>";
							}
						}
					?>
...
<script src="assets/public/js/simplyCountdown.js"></script>
